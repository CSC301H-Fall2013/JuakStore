...
'''
    Credit: https://bradmontgomery.net/blog/selecttimewidget-a-custom-django-widget/
'''
...
class SelectTimeWidget(Widget):
    ...
    def __init__(self, attrs=None, hour_step=None, minute_step=None, second_step=False, twelve_hr=False):
        """
